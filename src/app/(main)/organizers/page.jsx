...
const organizers = [
  {
    ...
    designation: "Founder of WIT Dreamin',Group Leader of Salesforce Women In Tech,Kolkata,Salesforce Marketing Champion,Trailblazer Community Forum Ambassador,Speaker,Trailhead Mentor,Hosts Podcast in India,Led Initiatives in India",
    imageUri:
  ...
  },
  {
    ...
    name: "Neetu Bansal",
    post: "Co-founder & Organiser of WIT Dreamin",
    designation: "Technical Architect at Deloitte | Salesforce MVP | Salesforce Trailblazer | Jaipur Women in Technology Leader | Adventurer | Traveller",
    imageUri:
...
const OrganizersPage = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-6 sm:p-8 overflow-x-hidden">
      ...
      <motion.h1
        className="text-4xl sm:text-6xl font-bold text-center mb-12 pb-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-transparent bg-clip-text"
...
const OrganizerCard = ({ organizer }) => {
  return (
    <motion.div
      className="relative bg-white rounded-lg shadow-lg overflow-hidden w-full box-border"
    >
      <div className="p-6 flex flex-col items-center w-full">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-center">{organizer.post}</h2>
        <p className="text-base text-center sm:text-lg text-gray-600">{organizer.designation}</p>
