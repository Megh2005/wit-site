  ...
  if (huntData?.data.status === "closed") {
    return (
      <div className="px-4 py-6">
        <p className="text-center capitalize font-bold text-xl">Hunt has been closed</p>
      </div>
    );
  }
    ...
    <div className="overflow-hidden h-screen px-4 py-6 justify-center items-center">
      ...
      <div>
        ...
        <p className="text-fuchsia-500 text-center font-semibold">
          ...
          <br /> You can take a look into your <span className="italic text-teal-600">
            Number System
          </span><br/> chapter for better reference
        </p>
      </div>
    </div>
  );
