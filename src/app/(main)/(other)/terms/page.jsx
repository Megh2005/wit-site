...
const TermsAndConditions = () => {
  return (
    <>
      <Head>
        <title>Terms and Conditions - WIT Dreamin</title>
      </Head>
      <motion.div
        className="max-w-5xl mx-auto p-6 prose prose-lg prose-indigo"
      ...
      >
        ...
        <ul className="list-disc list-inside mb-6">
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to WIT Dreamin, 12 Adrash
            Colony, Ajmer Road, Bhankrota, 302026, Jaipur, Rajasthan, India.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to WIT Dreamin 2024, accessible from{" "}
            <a
              href="https://wit-site-omega.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-indigo-600 hover:underline"
            >
              https://wit-site-omega.vercel.app/
            </a>
          </li>
          <li>
        ...
        <h2 className="text-3xl font-semibold mt-8 mb-4">Acknowledgment</h2>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-8 mb-4">Termination</h2>
        <p>
        ...
        <h2 className="text-3xl font-semibold mt-8 mb-4">Governing Law</h2>
        <p>
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-2">Severability</h3>
        <p>
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-2">Waiver</h3>
        <p>
        ...
        <ul className="list-disc list-inside mb-6">
          <li>
            ...
            <a
              href="https://wit-site-omega.vercel.app/contact"
              target="_blank"
              rel="noopener noreferrer"
              className="text-indigo-600 hover:underline"
            >
              https://wit-site-omega.vercel.app/contact
            </a>
          </li>
        </ul>
      </motion.div>
