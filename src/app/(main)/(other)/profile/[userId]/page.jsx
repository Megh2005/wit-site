...
const ProfilePage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[80vh] sm:min-h-[60vh]">
      <div className="mx-4 w-full max-w-xl bg-gradient-to-r from-teal-600 to-cyan-600 shadow-lg rounded-lg p-6 flex flex-col sm:flex-row items-center sm:items-start">
        {/* Profile Section */}
